...
class ElasticEnergy(ABC):
    ...
    @abstractmethod
    def get_strain(self, deformation): # will be uniquely defined for each individual elastic energy type
        pass
    
    @abstractmethod
    def grad_hess_strain(self, deformation): # will be uniquely defined for each individual elastic energy type
        pass
